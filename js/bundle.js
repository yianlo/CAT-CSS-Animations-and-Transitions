...
/***/ function(module, exports, __webpack_require__) {
	...
	var Intro = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'intro display-container' },
	      React.createElement(
	        'div',
	        { className: 'text-box' },
	        React.createElement(
...
/***/ function(module, exports) {
	...
	Player.prototype.fall = function () {
	  this.$player.animate({ marginTop: this.$player.parent().height() - this.$player.height() - this.$player.position().top + 'px' }, 700);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    Player = __webpack_require__(218),
	    Platform = __webpack_require__(219),
	    LinkedStateMixin = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"react-addons-linked-state-mixin\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
